...
public class GamePanel extends JPanel implements Runnable{
    ...
    final int scale = 3;
    final int scaleEntity = 9;

    public final int tileSize = originalTitleSize * scale; //48x48 tile
    public final int entitySize = originalTitleSize * scaleEntity; //144x144 tile
    public final int maxScreenCol = 16;
    public final int maxScreenRow = 12;
    public final int screenWidth = tileSize * maxScreenCol; // 768 pixel
    public final int screenHeigh = tileSize * maxScreenRow; // 576 pixel
...
//    public final int worldHeight = tileSize * maxWorldRow ;
    ...
    public AccessSetter aSetter = new AccessSetter(this);
